/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec99f4164e1ab69f8ef3de6fd4da3e8e)
...
interface __BaseEnv_Env {
	...
	OWNER_VAULT: DurableObjectNamespace<import("./src/index").OwnerVault>;
	OWNER_STORE: DurableObjectNamespace<import("./src/index").OwnerStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OwnerVault" | "OwnerStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_ORIGIN" | "GITHUB_API_ORIGIN" | "EXECUTE_TIMEOUT_MS" | "EXECUTION_BUDGET" | "FETCH_BUDGET" | "GATEWAY_INSECURE_HOSTS">> {}
}
